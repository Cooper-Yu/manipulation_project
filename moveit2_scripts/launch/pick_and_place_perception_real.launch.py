...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument("reviewed_grasp_test", default_value="true", description="Candidate X-thickness/2+0.003, Y+width/2-0.002, Z+height/2+0.1923; supports stop_at_grasp or full sequence; no diagnostic overrides."),
        ...
        DeclareLaunchArgument("execute", default_value="true", description="Execute the real robot sequence by default; set false for plan-only review."),
